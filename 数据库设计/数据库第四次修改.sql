CREATE DATABASE  IF NOT EXISTS `findwork` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `findwork`;
...
CREATE TABLE `t_user` (
  ...
  `create_at` datetime DEFAULT NULL COMMENT '创建时间',
  `update_at` datetime DEFAULT NULL COMMENT '修改时间',
  `CVid` int(10) DEFAULT NULL COMMENT '外键（简历表）',
  PRIMARY KEY (`Uid`),
  UNIQUE KEY `Uid` (`Uid`),
  KEY `FK_USER_ROLE_RID` (`Rid`),
  KEY `FK_USER_CV_idx` (`CVid`),
  CONSTRAINT `FK_USER_CV` FOREIGN KEY (`CVid`) REFERENCES `t_cv` (`Cid`),
...
INSERT INTO `t_user` VALUES (1,1,'王德略','123456','广东XXXXXX',NULL,'0',NULL,NULL,0,NULL,'2020-05-17 12:52:46','2020-05-17 12:52:46',NULL);
...
-- Dump completed on 2020-05-18 16:46:29

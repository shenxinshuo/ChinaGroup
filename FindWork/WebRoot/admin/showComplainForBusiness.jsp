...
<html>
  <head>
    ...
    <title>My JSP 'showComplain.jsp' starting page</title>
		...
		<div class="check_right">
				...
				<form class="form-horizontal" action="${admin_updateCheckFlag }" method="post">
					...
					<div class="form-group">
						<div class="form-inline col-md-12">
							...
							<div class="form-group col-md-6">
								...
								<input value="${business.city }" readonly="readonly" unselectable="on" class="form-control " size="25">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="form-inline col-md-12">
							...
							<div class="form-group col-md-6 ">
								...
								<input value="${business.email }" readonly="readonly" unselectable="on" class="form-control " size="25">
							</div>
						</div>
					</div>
					...
					<div class="btn-group" style="float: right;margin-top: 60px;">
						<a href="admin_checkBComplainForBusiness.action?blackList.id=${blackList.id }&business.id=${business.id }">投诉成功</a>
						<a href="admin_checkBComplainForBusinessNotPass.action?blackList.id=${blackList.id }">投诉失败</a>
					</div>

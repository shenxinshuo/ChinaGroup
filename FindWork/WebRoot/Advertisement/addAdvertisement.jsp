        ...
        <div class="col-md-8">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                	...
                	<s:if test="target=='add'">
                    <s:url id="AD" action="ad_add.action" namespace="/"></s:url>
                    </s:if>                   
                    <s:if test="target=='change'">
                    <s:url id="AD" action="ad_change.action" namespace="/"></s:url>
                     </s:if>
                    <form action="${AD}" class="form-horizontal" method="post" enctype="multipart/form-data">
                    	 <div class="col-md-12">
                            <div class="col-md-6">
                        ...
                        <s:hidden name="ad.picture" value="%{ad.picture}"></s:hidden>                    
                         <div class="col-md-12">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="ad.id" class="form-control" style="width:200px"> 

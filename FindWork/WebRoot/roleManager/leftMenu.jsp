...
<html>
  ...
  <body>
	...
	<div class="btn-group-vertical col-md-2" role="group" aria-label="..." style="margin-bottom: 20px;">
        ...
        <a href="<%=request.getContextPath() %>/roleManager/updateRole.jsp" class="btn btn-default ${param.currentPage == 'update' ? 'btn-primary' : '' }">修改角色</a>
        <a href="<%=request.getContextPath() %>/roleManager/showRoles.jsp" class="btn btn-default  ${param.currentPage == 'show' ? 'btn-primary' : '' }">查看角色</a>
